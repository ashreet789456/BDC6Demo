...
public class Demo_01_01_definitions {
	...
	public void adds_that_item_to_the_cart() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	    System.out.println("adds that item to the cart");
	}

	@Given("user has already placed a order for his favourite item")
	public void user_has_already_placed_a_order_for_his_favourite_item() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	    System.out.println("user has already placed a order for his favourite item");
	}

	@Then("user tries access the order tracking dashboard")
	public void user_tries_access_the_order_tracking_dashboard() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	    System.out.println("user tries access the order tracking dashboard");
	}
